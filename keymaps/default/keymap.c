...
// Short key names for layers
#define OSL_SYM OSL(SYMBOLS)
#define OSL_NAV OSL(NAV)
#define TT_MOUSE TT(MOUSE)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LSFT,  KC_Z,    KC_X,    KC_C,       KC_V,     KC_B,    /* */   KC_N,     KC_M,    KC_COMM,    KC_DOT,  KC_SLSH,  KC_RSFT,
                  XXXXXXX, KC_LBRC, S(KC_LBRC), S(KC_9),           /* */             S(KC_0), S(KC_RBRC), KC_RBRC, XXXXXXX,

                                                  KC_LCTL, KC_LALT,   /* */   KC_RALT,  KC_RCTL,
                                                           KC_LGUI,   /* */   KC_RGUI,
                                         KC_BSPC, OSL_SYM, OSL_NAV,   /* */   OSL_NAV,  KC_ENT,  KC_SPC
    ),
    ...
    [SYMBOLS] = LAYOUT(
        ...
        XXXXXXX,  M_UNDO,     M_CUT,     M_COPY,     M_PASTE,  KC_GRV,     /* */  S(KC_NUBS), KC_MINS,  S(KC_COMM), S(KC_DOT), S(KC_SLSH), XXXXXXX,
    ...
    [NAV] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME,  /* */   XXXXXXX, KC_PGUP,       XXXXXXX, XXXXXXX, S(C(KC_EQL)), XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN, XXXXXXX, XXXXXXX,  /* */   KC_LEFT, KC_DOWN,       KC_UP,   KC_RGHT, XXXXXXX,      XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,   /* */   XXXXXXX, S(C(KC_MINS)), XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX,
                 XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           /* */            XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,

                                            XXXXXXX, QK_BOOT,  /* */   QK_BOOT, XXXXXXX,
                                                     XXXXXXX,  /* */   XXXXXXX,
                                   XXXXXXX, XXXXXXX, XXXXXXX,  /* */   XXXXXXX, XXXXXXX, XXXXXXX
    ),
};
